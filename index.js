...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': '9652210df1msh3edb235f519360ap16c72ejsn0793f6ba05fe',
...
// console.log(graphData);
// //We use push method to add elements in an array
...
//For loops are used to do repetetive task, in this case to print out individual element in the graphData array and their respectective propecties
for (let i = 0; i < 25; i++) {
	graphData.push(
		{
